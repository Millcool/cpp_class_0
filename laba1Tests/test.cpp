...
TEST(CisoidaDioklaMetods, UsualTest_2) {
	...
	EXPECT_FLOAT_EQ(-2 * 2, Krivaya.printkoef());
	EXPECT_FLOAT_EQ(-3 * pow(sin(0 * PI / 180), 2) / cos(0 * PI / 180), Krivaya.rastdochentra(), 0.01);
...
TEST(CisoidaDioklaMetods, UsualTest_3) {
	...
	EXPECT_FLOAT_EQ(77 * pow(sin(60 * PI / 180),2) / cos(60 * PI / 180), Krivaya.rastdochentra(),0.01);
...
TEST(CisoidaDioklaMetods, UsualTest_4) {
	...
	EXPECT_NEAR(44 * pow(sin(55 * PI / 180),2) / cos(55 * PI / 180), Krivaya.rastdochentra(),0.01);
...
TEST(CisoidaDioklaMetods, UsualTest_5) {
	...
	ASSERT_NEAR(33 * pow(sin(10 * PI / 180),2) / cos(10 * PI / 180), Krivaya.rastdochentra(),0.01);
...
TEST(CisoidaDioklaMetods, UsualTest_6) {
	...
	EXPECT_NEAR(10 * pow(sin(32 * PI / 180), 2) / cos(32 * PI / 180), Krivaya.rastdochentra(), 0.01);
...
TEST(CisoidaDioklaMetods, UsualTest_7) {
	...
	EXPECT_NEAR(200 * pow(sin(5 * PI / 180), 2) / cos(5 * PI / 180), Krivaya.rastdochentra(), 0.01);
...
TEST(CisoidaDioklaMetods, UsualTest_8) {
	...
	EXPECT_NEAR(29 * pow(sin(35 * PI / 180), 2) / cos(35 * PI / 180), Krivaya.rastdochentra(), 0.01);
